...
<html lang="en">
<head>
    <title>Code coverage report for uvm/base-context.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">uvm/</a> base-context.js
    </h1>
    <div class='clearfix'>
 ...
 * @param callback
 */
module.exports.get = <span class="fstat-no" title="function not covered" >function (options, callback) {</span>
<span class="cstat-no" title="statement not covered" >    if (_.isFunction(options) &amp;&amp; !callback) {</span>
...
<span class="cstat-no" title="statement not covered" >    var context = vm.createContext();</span>
<span class="cstat-no" title="statement not covered" >    try {</span>
<span class="cstat-no" title="statement not covered" >        vm.runInContext(sugarjs, context);</span>
    }
    catch (e) {
<span class="cstat-no" title="statement not covered" >        return callback(e);</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    return callback(null, _.extend(context, (options &amp;&amp; options.base) ? options.base : undefined));</span>
};
&nbsp;</pre></td></tr>
</table></pre>
