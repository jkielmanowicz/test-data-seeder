...
<html lang="en">
<head>
    <title>Code coverage report for runner/util.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">runner/</a> util.js
    </h1>
    <div class='clearfix'>
...
module.exports = {
     ...
     */
    safeCall: <span class="fstat-no" title="function not covered" >function (fn, ctx) {</span>
...
<span class="cstat-no" title="statement not covered" >            (typeof fn === FUNCTION) &amp;&amp; fn.apply(ctx || global, args);</span>
        }
        catch (err) {
...
&nbsp;
     ...
     * @return {Object}
     */
    syncObject: <span class="fstat-no" title="function not covered" >function (dest, src) {</span>
<span class="cstat-no" title="statement not covered" >        var prop;</span>
&nbsp;
        // update or add values from src
<span class="cstat-no" title="statement not covered" >        for (prop in src) {</span>
<span class="cstat-no" title="statement not covered" >            if (src.hasOwnProperty(prop)) {</span>
<span class="cstat-no" title="statement not covered" >                dest[prop] = src[prop];</span>
            }
        }
&nbsp;
        // remove values that no longer exist
<span class="cstat-no" title="statement not covered" >        for (prop in dest) {</span>
<span class="cstat-no" title="statement not covered" >            if (dest.hasOwnProperty(prop) &amp;&amp; !src.hasOwnProperty(prop)) {</span>
<span class="cstat-no" title="statement not covered" >                delete dest[prop];</span>
            }
        }
